...
type AIClient interface {
	...
	ContinueLecture(ctx context.Context, topic string, agendaItems []AgendaItem, currentStep int, workspaceContext string, summary string, recentMessages []Message, userMessage string) (string, error)
