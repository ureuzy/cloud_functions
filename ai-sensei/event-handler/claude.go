...
func (c *ClaudeClient) SummarizeMessages(ctx context.Context, topic string, messages []Message, existingSummary string, agendaItems []AgendaItem, currentStep int) (string, error) {
	if len(messages) == 0 {
		return "", nil
	}
